...
export default function FormSection({ title, description, usp, graphic }) {
  ...
  if(graphic.graphic_type === "youtube_video"){ 
    graphicComponent = <Video videoHosted={"youtube"} videoID={graphic.youtube_video.youtube_id} placeholderImage={graphic.video.placeholder_image} showCompressedImage={true} />
  }
  return (
    <Section>
